...
export CC=/opt/toolchains/aarch32/bin/arm-linux-gnueabihf-gcc
export LD_LIBRARY_PATH=${c_dir}/lib
export PKG_CONFIG_PATH=${c_dir}/lib/pkgconfig
export C_INCLUDE_PATH=${c_dir}/include
export LIBRARY_PATH=${c_dir}/lib
export CGO_LDFLAGS="-L${c_dir}/lib -lsodium"
export CGO_ENABLED=1 GOOS=linux GOARCH=arm GOARM=7
...
source ${src_dir}/version/platform-linux-armv7.txt
...
cp -P ${c_dir}/lib/libsodium.so* ${lib_dir}
cp -P ${c_dir}/lib/libzmq.so* ${lib_dir}
